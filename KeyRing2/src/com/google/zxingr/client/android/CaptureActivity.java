 ...
 */
package com.google.zxingr.client.android;
...
import com.google.zxingr.ResultMetadataType;
import com.google.zxingr.ResultPoint;
import com.google.zxingr.client.android.camera.CameraManager;
import com.google.zxingr.client.android.history.HistoryManager;
import com.google.zxingr.client.android.result.ResultHandler;
import com.google.zxingr.client.android.result.ResultHandlerFactory;
import com.nihilent.keyring.activities.Holder;
import com.nihilent.keyring.R;


//import com.google.zxingr.client.android.share.ShareActivity;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
  ...
  private static final String PACKAGE_NAME = "com.google.zxingr.client.android";
...
//    setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
    ...
    data.putExtra("QR_DATA", rawResult.getText().toString());
    setResult(Activity.RESULT_OK, data);
    
    Holder.QR_DATA = rawResult.getText().toString();
    
    finish();
  /*
    
    TextView tv=(TextView) findViewById(R.id.Home_instruction);
    tv.setVisibility(View.VISIBLE);
    tv.setText("DECODED RESULT:"+rawResult.getText().toString());
    
    
    
    ImageView iv= (ImageView) findViewById(R.id.Home_QR_Button);
	iv.setImageBitmap(barcode); 
	
	Button home_exit=(Button) findViewById(R.id.Home_EXIT);
	Button home_next=(Button) findViewById(R.id.Home_Next);
	
	home_exit.setVisibility(View.VISIBLE);
	home_next.setVisibility(View.VISIBLE);
	home_exit.setOnClickListener(new OnClickListener() {
