 ...
 * the String it encodes. For example, {@link com.google.zxingr.qrcode.QRCodeReader} can
 * decode a QR code. The decoder may optionally receive hints from the caller which may help
 * it decode more quickly or accurately.
 *
 * See {@link com.google.zxingr.MultiFormatReader}, which attempts to determine what barcode
...
public interface Reader {
   ...
   *
   * @param image image of barcode to decode
   * @param hints passed as a {@link java.util.Hashtable} from {@link com.google.zxingr.DecodeHintType}
